...
public class UserInfoDAO {
	...
	public List<UserInfo> QueryUserInfo(String user_name,String classObj,String name,Timestamp birthDate,String telephone) {
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		try {
			/* 构建sql执行插入新用户 */
			String sqlString = "insert into UserInfo(user_name,password,classObj,name,gender,birthDate,userPhoto,telephone,email,address,regTime) values (";
